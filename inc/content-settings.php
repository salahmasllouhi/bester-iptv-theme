    ...
    private $content_fields = array(
        ...
        'comparison' => array(
            ...
            'fields' => array(
                ...
                // Row 1
                'comp_row_1_label' => array('label' => 'Row 1 Label', 'type' => 'text', 'default' => 'Live Channels'),
                'comp_row_1_val_1' => array('label' => 'Row 1 Competitor', 'type' => 'text', 'default' => '200+'),
                'comp_row_1_val_2' => array('label' => 'Row 1 Us', 'type' => 'text', 'default' => '35,000+'),

                // Row 2
                'comp_row_2_label' => array('label' => 'Row 2 Label', 'type' => 'text', 'default' => 'On-Demand Content'),
                'comp_row_2_val_1' => array('label' => 'Row 2 Competitor', 'type' => 'text', 'default' => 'Limited'),
                'comp_row_2_val_2' => array('label' => 'Row 2 Us', 'type' => 'text', 'default' => '150,000+ titles'),

                // Row 3 (Price)
                'comp_row_3_label' => array('label' => 'Row 3 Label', 'type' => 'text', 'default' => 'Annual Cost'),
                'comp_row_3_val_1' => array('label' => 'Row 3 Competitor', 'type' => 'text', 'default' => '$1,200+'),
                'comp_price' => array('label' => 'Row 3 Us (Price)', 'type' => 'text', 'default' => '$69.99'), // Specific key for currency translation

                // Row 4
                'comp_row_4_label' => array('label' => 'Row 4 Label', 'type' => 'text', 'default' => 'Sports Packages'),
                'comp_row_4_val_1' => array('label' => 'Row 4 Competitor', 'type' => 'text', 'default' => '$50+ extra'),
                'comp_row_4_val_2' => array('label' => 'Row 4 Us', 'type' => 'text', 'default' => 'Included'),

                // Row 5
                'comp_row_5_label' => array('label' => 'Row 5 Label', 'type' => 'text', 'default' => 'PPV Events'),
                'comp_row_5_val_1' => array('label' => 'Row 5 Competitor', 'type' => 'text', 'default' => '$79/event'),
                'comp_row_5_val_2' => array('label' => 'Row 5 Us', 'type' => 'text', 'default' => 'Included'),

                // Row 6
                'comp_row_6_label' => array('label' => 'Row 6 Label', 'type' => 'text', 'default' => 'Movie Rentals'),
                ...
                // Row 7
                'comp_row_7_label' => array('label' => 'Row 7 Label', 'type' => 'text', 'default' => 'Contracts'),
                'comp_row_7_val_1' => array('label' => 'Row 7 Competitor', 'type' => 'text', 'default' => 'Required'),
                'comp_row_7_val_2' => array('label' => 'Row 7 Us', 'type' => 'text', 'default' => 'No'),

                // Row 8
                'comp_row_8_label' => array('label' => 'Row 8 Label', 'type' => 'text', 'default' => 'Multi-Device Streaming'),
                'comp_row_8_val_1' => array('label' => 'Row 8 Competitor', 'type' => 'text', 'default' => 'Extra Fees'),
                'comp_row_8_val_2' => array('label' => 'Row 8 Us', 'type' => 'text', 'default' => 'Included'),
            )
        ),
        'steps' => array(
            'label' => 'Steps Section',
        ...
        'sports' => array(
            ...
            'fields' => array(
                // Sport 1: NFL
                'sport_1_name' => array('label' => 'Sport 1 Name', 'type' => 'text', 'default' => 'NFL'),
                'sport_1_subtitle' => array('label' => 'Sport 1 Subtitle', 'type' => 'text', 'default' => 'American Football'),
                'sport_1_feat_1' => array('label' => 'Sport 1 Feature 1', 'type' => 'text', 'default' => 'Sunday Ticket'),
                'sport_1_feat_2' => array('label' => 'Sport 1 Feature 2', 'type' => 'text', 'default' => 'RedZone Channel'),
                'sport_1_feat_3' => array('label' => 'Sport 1 Feature 3', 'type' => 'text', 'default' => 'Super Bowl 4K'),

                // Sport 2: NBA
                'sport_2_name' => array('label' => 'Sport 2 Name', 'type' => 'text', 'default' => 'NBA'),
                'sport_2_subtitle' => array('label' => 'Sport 2 Subtitle', 'type' => 'text', 'default' => 'Basketball'),
                'sport_2_feat_1' => array('label' => 'Sport 2 Feature 1', 'type' => 'text', 'default' => 'All Regular Season'),
                'sport_2_feat_2' => array('label' => 'Sport 2 Feature 2', 'type' => 'text', 'default' => 'Playoffs & Finals'),
                'sport_2_feat_3' => array('label' => 'Sport 2 Feature 3', 'type' => 'text', 'default' => 'March Madness'),

                // Sport 3: MLB
                'sport_3_name' => array('label' => 'Sport 3 Name', 'type' => 'text', 'default' => 'MLB'),
                'sport_3_subtitle' => array('label' => 'Sport 3 Subtitle', 'type' => 'text', 'default' => 'Baseball'),
                'sport_3_feat_1' => array('label' => 'Sport 3 Feature 1', 'type' => 'text', 'default' => 'Full Season'),
                'sport_3_feat_2' => array('label' => 'Sport 3 Feature 2', 'type' => 'text', 'default' => 'World Series'),
                'sport_3_feat_3' => array('label' => 'Sport 3 Feature 3', 'type' => 'text', 'default' => 'All-Star Game'),

                // Sport 4: Soccer
                'sport_4_name' => array('label' => 'Sport 4 Name', 'type' => 'text', 'default' => 'Soccer'),
                'sport_4_subtitle' => array('label' => 'Sport 4 Subtitle', 'type' => 'text', 'default' => 'MLS & International'),
                'sport_4_feat_1' => array('label' => 'Sport 4 Feature 1', 'type' => 'text', 'default' => 'Premier League'),
                'sport_4_feat_2' => array('label' => 'Sport 4 Feature 2', 'type' => 'text', 'default' => 'Champions League'),
                'sport_4_feat_3' => array('label' => 'Sport 4 Feature 3', 'type' => 'text', 'default' => 'World Cup'),

                // Sport 5: NHL
                'sport_5_name' => array('label' => 'Sport 5 Name', 'type' => 'text', 'default' => 'NHL'),
                'sport_5_subtitle' => array('label' => 'Sport 5 Subtitle', 'type' => 'text', 'default' => 'Ice Hockey'),
                'sport_5_feat_1' => array('label' => 'Sport 5 Feature 1', 'type' => 'text', 'default' => 'Regular Season'),
                'sport_5_feat_2' => array('label' => 'Sport 5 Feature 2', 'type' => 'text', 'default' => 'Stanley Cup'),
                'sport_5_feat_3' => array('label' => 'Sport 5 Feature 3', 'type' => 'text', 'default' => 'Winter Classic'),

                // Sport 6: Tennis
                'sport_6_name' => array('label' => 'Sport 6 Name', 'type' => 'text', 'default' => 'Tennis'),
                'sport_6_subtitle' => array('label' => 'Sport 6 Subtitle', 'type' => 'text', 'default' => 'ATP & WTA'),
                'sport_6_feat_1' => array('label' => 'Sport 6 Feature 1', 'type' => 'text', 'default' => 'Grand Slams'),
                'sport_6_feat_2' => array('label' => 'Sport 6 Feature 2', 'type' => 'text', 'default' => 'US Open'),
                'sport_6_feat_3' => array('label' => 'Sport 6 Feature 3', 'type' => 'text', 'default' => 'Wimbledon'),

                // Sport 7: Golf
                'sport_7_name' => array('label' => 'Sport 7 Name', 'type' => 'text', 'default' => 'Golf'),
                'sport_7_subtitle' => array('label' => 'Sport 7 Subtitle', 'type' => 'text', 'default' => 'PGA Tour'),
                'sport_7_feat_1' => array('label' => 'Sport 7 Feature 1', 'type' => 'text', 'default' => 'Masters'),
                'sport_7_feat_2' => array('label' => 'Sport 7 Feature 2', 'type' => 'text', 'default' => 'PGA Championship'),
                'sport_7_feat_3' => array('label' => 'Sport 7 Feature 3', 'type' => 'text', 'default' => 'US Open'),

                // Sport 8: Motorsports
                'sport_8_name' => array('label' => 'Sport 8 Name', 'type' => 'text', 'default' => 'Motorsports'),
                'sport_8_subtitle' => array('label' => 'Sport 8 Subtitle', 'type' => 'text', 'default' => 'NASCAR & F1'),
                'sport_8_feat_1' => array('label' => 'Sport 8 Feature 1', 'type' => 'text', 'default' => 'NASCAR Cup'),
                'sport_8_feat_2' => array('label' => 'Sport 8 Feature 2', 'type' => 'text', 'default' => 'Formula 1'),
                'sport_8_feat_3' => array('label' => 'Sport 8 Feature 3', 'type' => 'text', 'default' => 'Indy 500'),

                // Sport 9: Combat Sports
                'sport_9_name' => array('label' => 'Sport 9 Name', 'type' => 'text', 'default' => 'Combat Sports'),
                'sport_9_subtitle' => array('label' => 'Sport 9 Subtitle', 'type' => 'text', 'default' => 'Boxing & MMA'),
                'sport_9_feat_1' => array('label' => 'Sport 9 Feature 1', 'type' => 'text', 'default' => 'UFC PPV'),
                'sport_9_feat_2' => array('label' => 'Sport 9 Feature 2', 'type' => 'text', 'default' => 'Boxing Title Fights'),
                'sport_9_feat_3' => array('label' => 'Sport 9 Feature 3', 'type' => 'text', 'default' => 'Bellator'),

                // Sport 10: Track & Field
                'sport_10_name' => array('label' => 'Sport 10 Name', 'type' => 'text', 'default' => 'Track & Field'),
                'sport_10_subtitle' => array('label' => 'Sport 10 Subtitle', 'type' => 'text', 'default' => 'World Athletics'),
                'sport_10_feat_1' => array('label' => 'Sport 10 Feature 1', 'type' => 'text', 'default' => 'World Championships'),
                'sport_10_feat_2' => array('label' => 'Sport 10 Feature 2', 'type' => 'text', 'default' => 'Diamond League'),
                'sport_10_feat_3' => array('label' => 'Sport 10 Feature 3', 'type' => 'text', 'default' => 'Olympic Games'),
            ...
            <script>
                ...
                jQuery(document).ready(function ($) {
                    ...
                    $('#generate-all-btn').on('click', function () {
                        // Show progress bar
                        showProgress('Generating content for all languages...');
                        ...
                        function next() {
                            ...
                            if (index < translateLanguages.length) {
                                updateProgress(index, totalLangs, 'Generating ' + translateLanguages[index].toUpperCase());
                                generateContent(translateLanguages[index], function () {
                                    index++;
