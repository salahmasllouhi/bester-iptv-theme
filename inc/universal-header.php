...
<div class="mobile-menu" id="mobile-menu">
    ...
    <a href="<?php echo home_url('/#features'); ?>" onclick="toggleMobileMenu()">Features</a>
    <a href="<?php echo home_url('/#pricing'); ?>" onclick="toggleMobileMenu()">Pricing</a>
    ...
    <a href="<?php echo home_url('/contact-us/'); ?>" onclick="toggleMobileMenu()">Contact</a>
    ...
    <a href="<?php echo home_url('/#pricing'); ?>" class="nav-btn nav-btn-primary" style="margin-top:1rem;"
        onclick="toggleMobileMenu()">Get Access Now</a>
</div>
...
<script>
    ...
    function setCurrency(currency) {
        const flags = { usd: '🇺🇸', eur: '🇫🇮', sek: '🇸🇪', nok: '🇳🇴', dkk: '🇩🇰', isk: '🇮🇸' };
        const codes = { usd: 'USD', eur: 'EUR', sek: 'SEK', nok: 'NOK', dkk: 'DKK', isk: 'ISK' };
        document.getElementById('selectedFlag').textContent = flags[currency];
        document.getElementById('selectedCode').textContent = codes[currency];
