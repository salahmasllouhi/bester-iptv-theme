<?php
/**
 * Section: IPTV Anbieter vs. traditional services (Design v2)
 */
...
<section class="comparison dv2-section">
    <div class="comparison-inner">
        <div class="dv2-section-head">
            <h2><?php echo esc_html(iptv_text('comp_title_main', 'IPTV Anbieter vs. Traditional Services')); ?></h2>
            <p>
                <?php echo esc_html(iptv_text('comp_desc', 'As the most affordable IPTV service provider, stop paying for streaming apps, a sports package, and cable TV separately. IPTV Anbieter replaces them all.')); ?>
            </p>
        </div>
        ...
        <div class="dv2-compare">
            <div class="dv2-compare-head">
                <div class="dv2-compare-head-ours">
                    <div class="dv2-compare-head-label"><?php echo esc_html(iptv_text('comp_ours_label', 'IPTV Anbieter')); ?></div>
