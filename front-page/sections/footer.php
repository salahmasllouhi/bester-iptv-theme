    ...
    <div class="container">
        <div class="footer-grid">
            <div>
                ...
                <p class="footer-desc">
                    <?php echo esc_html(iptv_text('footer_desc', 'Der führende IPTV Anbieter — über 40.000 Live-Sender, mehr als 200.000 Filme und Serien, jeder Sport, in 4K und 8K.')); ?>
                </p>
            ...
            <div class="footer-col">
                <h4><?php echo esc_html(iptv_get_menu_title('footer_1', iptv_text('footer_head_plans', 'Pakete'))); ?></h4>
            ...
            <div class="footer-col">
                ...
                <?php else: ?>
                    ...
                    iptv_footer_links(array(
                        ...
                        array('slug' => 'iptv-guide-setup-apps-devices-tips', 'key' => 'footer_link_guide', 'label' => 'Einrichtung'),
                        array('slug' => 'm3u-playlist-convert-your-m3u-url', 'key' => 'footer_link_m3u', 'label' => 'M3U-Konverter'),
                        array('slug' => 'contact-us', 'key' => 'footer_link_contact', 'label' => 'Kontakt'),
                        array('url' => 'https://panel.nordictv.io/login', 'key' => 'footer_link_account', 'label' => 'Mein Konto'),
                    ));
                    ?>
                <?php endif; ?>
            </div>
            ...
            <div class="footer-col">
                <h4><?php echo esc_html(iptv_get_menu_title('footer_3', iptv_text('footer_head_legal', 'Rechtliches'))); ?></h4>
                ...
                <?php else: ?>
                    ...
                    iptv_footer_links(array(
                        array('slug' => 'about-us', 'key' => 'footer_link_about', 'label' => 'Über uns'),
                        array('slug' => 'privacy-policy', 'key' => 'footer_link_privacy', 'label' => 'Datenschutz'),
                        array('slug' => 'terms-of-services', 'key' => 'footer_link_terms', 'label' => 'AGB'),
                        array('slug' => 'return-refund-policy', 'key' => 'footer_link_refund', 'label' => 'Widerruf & Rückerstattung'),
                    ));
                    ?>
                <?php endif; ?>
            </div>
        ...
        <div class="footer-bottom">
            IPTV Anbieter | <?php echo esc_html(iptv_text('footer_copyright', 'Alle Rechte vorbehalten.')); ?>
            <?php echo date('Y'); ?>
        </div>
    </div>
</footer>
