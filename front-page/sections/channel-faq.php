...
$faq_subtitle = tpl_str('Common questions about watching %s with IPTV Anbieter');
$faq_items = function_exists('get_field') ? get_field('tpl_faq_items', $post_id) : [];

// Default FAQ items — all go through tpl_str()
if (empty($faq_items)) {
    $faq_items = [
        ['faq_q' => tpl_str('How do I watch %s with IPTV Anbieter?'), 'faq_a' => tpl_str('Simply subscribe to any IPTV Anbieter plan, download our app on your device, and search for %s. You\'ll be streaming in minutes.')],
        ...
        ['faq_q' => tpl_str('Is there a trial?'), 'faq_a' => tpl_str('Yes! All IPTV Anbieter plans come with a 24h trial. You can cancel anytime during the trial period.')],
        ['faq_q' => tpl_str('Do I need a cable subscription?'), 'faq_a' => tpl_str('No! IPTV Anbieter is a standalone streaming service. No cable, no satellite dish, no contracts. Just an internet connection.')],
    ];
}
