...
$schema = [
    ...
    'description' => has_excerpt()
        ? get_the_excerpt()
        : 'Watch ' . get_the_title() . ' with IPTV Anbieter. All seasons and episodes available.',
    'url' => get_permalink(),
    'provider' => [
        '@type' => 'Organization',
        'name' => 'IPTV Anbieter',
...
$schema['offers'] = [
    ...
    'description' => 'IPTV Anbieter subscription including ' . get_the_title() . ' and 200,000+ movies & shows',
    'seller' => [
        '@type' => 'Organization',
        'name' => 'IPTV Anbieter',
    ],
