    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'required' => 0,
                'placeholder' => 'e.g. Stream NFL live with IPTV Anbieter. No cable required. No blackouts. No restrictions.',
                'maxlength' => 250,
                'rows' => 3,
                'new_lines' => 'br',
            ],
            ...
            [
                ...
                'name' => 'sport_networks',
                'type' => 'text',
                'instructions' => 'Comma-separated list of leagues, events or networks. E.g. "NFL, Super Bowl, Monday Night Football"',
                'required' => 0,
                'placeholder' => 'e.g. NFL, Super Bowl, Monday Night Football',
            ],
