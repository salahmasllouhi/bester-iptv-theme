...
$cta_subtitle = spl_str('Join thousands of satisfied customers streaming %s and 40,000+ channels with IPTV Anbieter.');
$cta_btn_text = spl_str('Get Access Now');
$cta_badge_1 = spl_str('256-bit SSL Encryption');
$cta_badge_2 = spl_str('Instant Activation');
$cta_badge_3 = spl_str('24/7 Customer Support');
...
<section class="cta">
    <div class="cta-content">
        <h2><?php echo wp_kses_post(sprintf($cta_title, $sn)); ?></h2>
        <p><?php echo wp_kses_post(sprintf($cta_subtitle, $sn)); ?></p>
